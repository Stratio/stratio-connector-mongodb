...
public class SupportedOperationsCreator implements IConfiguration {
    ...
    static {
        ...
        support.put(Operations.SELECT_OPERATOR, Boolean.TRUE);
        ...
        support.put(Operations.FILTER_PK_EQ, Boolean.TRUE);
        support.put(Operations.FILTER_PK_GT, Boolean.TRUE);
        support.put(Operations.FILTER_PK_LT, Boolean.TRUE);
        support.put(Operations.FILTER_PK_GET, Boolean.TRUE);
        support.put(Operations.FILTER_PK_LET, Boolean.TRUE);
