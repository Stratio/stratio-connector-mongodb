...
public class UpdateDBObjectBuilder {
	...
	public void addUpdateRelation(Selector left, Operator operator,
			Selector right) throws UnsupportedException, ExecutionException {
	...
	private DBObject getNumberRelation(Selector left, Selector right) throws MongoValidationException, ExecutionException {
	...
	private DBObject getBasicRelation(Selector left, Selector right) throws ExecutionException{
		return new BasicDBObject((String)SelectorHelper.getRestrictedValue(left, SelectorType.COLUMN), SelectorHelper.getValue(right));
		
	} 
	
	private DBObject getIncrementalRelation(Selector left, Selector right, boolean isDecrement) throws ExecutionException, MongoValidationException{
    ...
    private static Number retrieveNumberDataType(Selector selector, boolean isDecrement) throws MongoValidationException, ExecutionException {
		...
		case RELATION:
		default:
            throw new MongoValidationException("The requested operation does not support the type: " + selector.getType().toString());
