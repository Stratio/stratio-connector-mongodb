...
import com.stratio.connector.commons.ftest.functionalMetadata.GenericMetadataIndexFT;
import com.stratio.connector.commons.ftest.helper.IConnectorHelper;
import com.stratio.connector.mongodb.ftest.helper.MongoConnectorHelper;
import com.stratio.crossdata.common.exceptions.ConnectionException;
import com.stratio.crossdata.common.exceptions.InitializationException;

public class IndexFT extends GenericMetadataIndexFT {
...
// pk.add(columnPK);
// }
// ((MongoStorageEngine) connector.getStorageEngine()).insert(getClusterName(), new TableMetadata(new TableName(CATALOG,
// TABLE),null,null,null,null,null, Collections.EMPTY_LIST), row);
//
...
// // assertEquals("Index created", true, collection.getIndexInfo().contains("value1")); //evitar que se cree si no
// existe el campo? //hacer unique para evitar duplicados
//
// }
//
// private void insertRow(ClusterName cluesterName, Object value_4, String PK_VALUE, boolean withPK) throws
...
//
//
// connector.getStorageEngine().insert(cluesterName, new TableMetadata(new TableName(CATALOG,
// TABLE),null,null,null,null,pk, Collections.EMPTY_LIST), row);
// refresh(CATALOG);
// }
//
//
//
// @Test
// public void testDropIndex() throws UnsupportedOperationException,
...
//
// @Test
// public void testDropIndexes() throws UnsupportedOperationException,
// com.stratio.connector.meta.exception.UnsupportedOperationException {
//
//
//
